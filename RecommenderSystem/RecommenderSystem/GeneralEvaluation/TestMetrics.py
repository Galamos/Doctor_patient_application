...
print("Loading specialist ratings...")
data = main.loadData()
...
for trainSet, testSet in LOOCV.split(data):
    ...
    # See how often we recommended a specialist the user actually rated
    ...
    # See how often we recommended a specialist the user actually liked
    print("\ncHR (Cumulative Hit Rate, rating >= 3): ", RecommenderMetrics.CumulativeHitRate(topNPredicted, leftOutPredictions, 4.0))
